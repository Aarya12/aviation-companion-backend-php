...
<tr>
    <td style="padding: 0 45px 50px; font-family: arial; font-size: 14px; font-weight: bold; color: #000; line-height: normal;"
        width="550">The {{site_name}} Companion
    </td>
</tr>
{{-- <tr>
    <td align="center"
        style="padding:20px 45px; font-family: arial; background:#E5E5E5;color: #fff; font-size:15px; margin:0;"
        width="550">{{footer_text}}</td>
</tr> --}}
</tbody>
</table>
</td>
